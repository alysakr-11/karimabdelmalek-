...
/**
 * The two ways to use the phone number, side by side: a call, or a WhatsApp
 * message. The number itself is not written out; the buttons carry it (and
 * name it to screen readers).
 *
